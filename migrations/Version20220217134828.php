 ...
 */
<<<<<<< HEAD:migrations/Version20220217134828.php
final class Version20220217134828 extends AbstractMigration
=======
final class Version20220217085853 extends AbstractMigration
>>>>>>> dev:migrations/Version20220217085853.php
{
...
<<<<<<< HEAD:migrations/Version20220217134828.php
        $this->addSql('CREATE TABLE apsa (id INT AUTO_INCREMENT NOT NULL, champ_apprentissage_id INT DEFAULT NULL, libelle VARCHAR(255) NOT NULL, INDEX IDX_C8885CD158FC6EC8 (champ_apprentissage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE champ_apprentissage (id INT AUTO_INCREMENT NOT NULL, color_id INT DEFAULT NULL, libelle VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_D7B2408E7ADA1FB5 (color_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE choixannee (id INT AUTO_INCREMENT NOT NULL, niveau_id INT DEFAULT NULL, annee_id INT DEFAULT NULL, champ_apprentissage_id INT DEFAULT NULL, INDEX IDX_D6C5F2E6B3E9C81 (niveau_id), INDEX IDX_D6C5F2E6543EC5F0 (annee_id), INDEX IDX_D6C5F2E658FC6EC8 (champ_apprentissage_id), UNIQUE INDEX UNIQ_D6C5F2E6B3E9C81543EC5F058FC6EC8 (niveau_id, annee_id, champ_apprentissage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
=======
...
>>>>>>> dev:migrations/Version20220217085853.php
        ...
        $this->addSql('CREATE TABLE color (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
...
<<<<<<< HEAD:migrations/Version20220217134828.php
        ...
        $this->addSql('ALTER TABLE champ_apprentissage ADD CONSTRAINT FK_D7B2408E7ADA1FB5 FOREIGN KEY (color_id) REFERENCES color (id)');
=======
...
>>>>>>> dev:migrations/Version20220217085853.php
        ...
        $this->addSql('ALTER TABLE choixannee ADD CONSTRAINT FK_D6C5F2E658FC6EC8 FOREIGN KEY (champ_apprentissage_id) REFERENCES champ_apprentissage (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE choixannee DROP FOREIGN KEY FK_D6C5F2E658FC6EC8');
...
<<<<<<< HEAD:migrations/Version20220217134828.php
        $this->addSql('ALTER TABLE champ_apprentissage DROP FOREIGN KEY FK_D7B2408E7ADA1FB5');
...
<<<<<<< HEAD:migrations/Version20220217134828.php
        ...
        $this->addSql('DROP TABLE champ_apprentissage');
=======
